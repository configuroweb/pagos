...
if (isset($_REQUEST['act']) && @$_REQUEST['act'] == "1") {
  $errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Proceso Exitoso!</strong> El pago ha sido enviado</div>";
}
...
<div id="page-wrapper">
  <div id="page-inner">
    <div class="row">
      <div class="col-md-12">
        <h1 class="page-head-line">Gestionar Pagos
      ...
      $(document).ready(function() {
        ...
        */
        ...
        function mydatatable() {
          ...
          $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Nombre/Contacto</th><th>Pagos</th><th>Balance</th><th>Grade</th><th>Fecha Nacimiento</th><th>Acción</th></tr></thead><tbody></tbody></table>');
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Recoger Pagos</h4>
          </div>
